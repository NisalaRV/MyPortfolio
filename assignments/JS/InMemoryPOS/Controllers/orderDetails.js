...
function addCartData() {
    $("#placeOrders> tr").detach();

    for (var tc of tempOrderCartAr){
        var row="<tr><td>"+tc.orderid+"</td><td>"+tc.itemCode+"</td><td>"+tc.description+"</td><td>"+tc.price+"</td><td>"+tc.qty+"</td><td>"+tc.total+"</td></tr>";
        $('#placeOrders').append(row);
    }
    bindTrEvents();
    getTotal();
}
